...
/**
 * Host-side debug helper for FocusTransportSolver.
 */
template <typename GridType, int VecDim, typename DeviceType>
struct FocusTransportSolverDebugger {
    using solver_type = FocusTransportSolver<GridType, VecDim, DeviceType>;
    ...
    static void inspect_solver(const solver_type& solver,
        ...
        output << "[Debug] Inspecting Focus Solver Grid: ";
    ...
    /**
     * Print focused transport terms for one particle.
     */
    static void print_particle_transport_terms(
        ...
        output << "[Debug] Focused particle transport terms\n";
        ...
        print_scalar_line(output, "mu", terms.mu, 1.0,
        ...
        output << "[Debug] dX/dt = v mu b + V_sw + V_d + nabla_dot_kappa_perp\n";
        print_vector_line(output, "v mu b", terms.streaming_velocity,
                          unit_system.scale(Units::Dimensions::velocity),
                          "code_velocity", "cm s^-1");
        ...
        print_vector_line(output, "V_d", terms.drift_velocity,
                          unit_system.scale(Units::Dimensions::velocity),
                          "code_velocity", "cm s^-1");
        print_vector_line(output, "nabla_dot_kappa_perp",
                          terms.diffusion_advection,
                          unit_system.scale(Units::Dimensions::velocity),
                          "code_velocity", "cm s^-1");
        print_vector_line(output, "total dX/dt", terms.total_advection,
                          unit_system.scale(Units::Dimensions::velocity),
                          "code_velocity", "cm s^-1");
        ...
        output << "[Debug] dp/dt focused adiabatic term\n";
        print_scalar_line(output, "div(V_sw)", terms.solar_wind_divergence,
                          1.0 / unit_system.scale(Units::Dimensions::time),
                          "code_time^-1", "s^-1");
        print_scalar_line(output, "bb:grad(V_sw)", terms.bb_grad_solar_wind,
                          1.0 / unit_system.scale(Units::Dimensions::time),
                          "code_time^-1", "s^-1");
        print_scalar_line(output, "b dot dV_sw/dt",
                          terms.b_dot_solar_wind_total_derivative,
                          unit_system.scale(Units::Dimensions::acceleration),
                          "code_acceleration", "cm s^-2");
        print_scalar_line(output, "dp/dt", terms.momentum_rate,
                          unit_system.scale(Units::Dimensions::momentum) /
                              unit_system.scale(Units::Dimensions::time),
                          "code_momentum/code_time", "g cm s^-2");

        output << "[Debug] dmu = (focusing + dD_mumu/dmu) dt + sqrt(2D_mumu) dW\n";
        print_scalar_line(output, "b dot grad(ln|B|)",
                          terms.magnetic_focusing,
                          1.0 / unit_system.scale(Units::Dimensions::length),
                          "code_length^-1", "cm^-1");
        print_scalar_line(output, "focusing_mu_rate",
                          terms.focusing_mu_rate,
                          1.0 / unit_system.scale(Units::Dimensions::time),
                          "code_time^-1", "s^-1");
        print_scalar_line(output, "D_mumu", terms.D_mumu,
                          1.0 / unit_system.scale(Units::Dimensions::time),
                          "code_time^-1", "s^-1");
        print_scalar_line(output, "dD_mumu/dmu", terms.dD_mumu_dmu,
                          1.0 / unit_system.scale(Units::Dimensions::time),
                          "code_time^-1", "s^-1");
        print_scalar_line(output, "dmu/dt deterministic", terms.mu_rate,
                          1.0 / unit_system.scale(Units::Dimensions::time),
                          "code_time^-1", "s^-1");
        print_scalar_line(output, "scattering_sigma2",
                          terms.scattering_sigma2, 1.0,
                          "dimensionless", "dimensionless");
        print_scalar_line(output, "scattering_Lc",
        ...
        print_scalar_line(output, "kappa_perpendicular", terms.kappa_perpendicular,
                          unit_system.scale(Units::Dimensions::diffusion_coefficient),
                          "code_length^2/code_time", "cm^2 s^-1");
        print_coordinate_line(output, "kappa_perp_effective",
                              terms.kappa_perpendicular_effective,
                              unit_system.scale(
                                  Units::Dimensions::diffusion_coefficient),
                              "code_length^2/code_time", "cm^2 s^-1");
        print_scalar_line(output, "spatial_diffusion_dt_bound",
                          terms.diffusion_time_step,
                          unit_system.scale(Units::Dimensions::time),
                          "code_time", "s");
        print_scalar_line(output, "spatial_advection_dt_bound",
                          terms.advection_time_step,
                          unit_system.scale(Units::Dimensions::time),
                          "code_time", "s");
        print_scalar_line(output, "momentum_dt_bound",
                          terms.momentum_time_step,
                          unit_system.scale(Units::Dimensions::time),
                          "code_time", "s");
        print_scalar_line(output, "mu_advection_dt_bound",
                          terms.pitch_angle_advection_time_step,
                          unit_system.scale(Units::Dimensions::time),
                          "code_time", "s");
        print_scalar_line(output, "mu_diffusion_dt_bound",
                          terms.pitch_angle_diffusion_time_step,
                          unit_system.scale(Units::Dimensions::time),
                          "code_time", "s");
        print_scalar_line(output, "mu_balance_dt_bound",
                          terms.pitch_angle_balance_time_step,
                          unit_system.scale(Units::Dimensions::time),
                          "code_time", "s");
...
>
using FocusSolverDebugger =
    FocusTransportSolverDebugger<GridType, VecDim, DeviceType>;
