...
export KPT_TRANSPORT_MODEL="${KPT_TRANSPORT_MODEL:-focused}"
export KPT_BENCHMARK_ROOT="${KPT_BENCHMARK_ROOT:-${REPO_ROOT}/benchmark_runs/reconnection_focused_200}"
export KPT_FORTRAN_CONF_NAME="${KPT_FORTRAN_CONF_NAME:-conf_reconnection_kpt_focused_benchmark.dat}"
...
export KPT_PARTICLE_V0="${KPT_PARTICLE_V0:-17.20195}"
export KPT_DUU0="${KPT_DUU0:-5578.445}"
